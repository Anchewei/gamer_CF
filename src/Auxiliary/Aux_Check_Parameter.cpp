...
#  if ( EOS != EOS_GAMMA  &&  EOS != EOS_ISOTHERMAL  &&  EOS != EOS_NUCLEAR  &&  EOS != EOS_TABULAR  &&  EOS != EOS_USER && EOS != EOS_SAUMON_CHABRIER && EOS != EOS_BAROTROP1D && EOS != EOS_ANALYTICAL_BAROTROP )
