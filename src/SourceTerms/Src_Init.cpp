...
#  endif
#  if ( defined ISM && MODEL == HYDRO )
   SrcTerms.Cooling_FuncPtr            = NULL;
   SrcTerms.Cooling_AuxArrayDevPtr_Flt = NULL;
   SrcTerms.Cooling_AuxArrayDevPtr_Int = NULL;
#  endif
...
//    check if the source-term function is set properly
      if ( SrcTerms.Cooling_FuncPtr == NULL )   Aux_Error( ERROR_INFO, "SrcTerms.Cooling_FuncPtr == NULL !!\n" );
   }
#  endif
