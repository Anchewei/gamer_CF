...
2. This file is shared by both CPU and GPU
   ...
   GPU_EoS_Piecewise_SC.cu -> CPU_EoS_Piecewise_SC.cpp
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_SetAuxArray_Piecewise_SC
// Description :  Set the auxiliary arrays AuxArray_Flt/Int[]
//
// Note        :  1. Invoked by EoS_Init_Piecewise_SC()
...
//-------------------------------------------------------------------------------------------------------
#ifndef __CUDACC__
void EoS_SetAuxArray_Piecewise_SC( double AuxArray_Flt[], int AuxArray_Int[] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_DensEint2Pres_Piecewise_SC
...
//                2. See EoS_SetAuxArray_Piecewise_SC() for the values stored in AuxArray_Flt/Int[]
//
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensEint2Pres_Piecewise_SC( const real Dens, const real Eint, const real Passive[],
...
#  endif // GAMER_DEBUG
   ...
   const real rho_PW_SC    = (real)AuxArray_Flt[7];
   real Temp, Cs2, Pres;
   ...
   {
      Temp = T0*POW(rho_PW_SC, -Gamma_m1)*POW(Dens, Gamma_m1);
   }
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_DensPres2Eint_Piecewise_SC
// Description :  Convert gas mass density and pressure to gas internal energy density
//
// Note        :  1. See EoS_DensEint2Pres_Piecewise_SC()
//
// Parameter   :  Dens       : Gas mass density
//                Pres       : Gas pressure
//                Passive    : Passive scalars
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensPres2Eint_Piecewise_SC( const real Dens, const real Pres, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_DensPres2CSqr_Piecewise_SC
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensPres2CSqr_Piecewise_SC( const real Dens, const real Pres, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_DensEint2Temp_Piecewise_SC
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensEint2Temp_Piecewise_SC( const real Dens, const real Eint, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_DensTemp2Pres_Piecewise_SC
// Description :  Convert gas mass density and temperature to gas pressure
//
// Note        :  1. See EoS_SetAuxArray_Piecewise_SC() for the values stored in AuxArray_Flt/Int[]
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensTemp2Pres_Piecewise_SC( const real Dens, const real Temp, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_DensEint2Entr_Piecewise_SC
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensEint2Entr_Piecewise_SC( const real Dens, const real Eint, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_General_Piecewise_SC
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static void EoS_General_Piecewise_SC( const int Mode, real Out[], const real In_Flt[], const int In_Int[],
                                       const double AuxArray_Flt[], const int AuxArray_Int[],
                                       const real *const Table[EOS_NTABLE_MAX] )
{
...
FUNC_SPACE EoS_DE2P_t EoS_DensEint2Pres_Ptr = EoS_DensEint2Pres_Piecewise_SC;
FUNC_SPACE EoS_DP2E_t EoS_DensPres2Eint_Ptr = EoS_DensPres2Eint_Piecewise_SC;
FUNC_SPACE EoS_DP2C_t EoS_DensPres2CSqr_Ptr = EoS_DensPres2CSqr_Piecewise_SC;
FUNC_SPACE EoS_DE2T_t EoS_DensEint2Temp_Ptr = EoS_DensEint2Temp_Piecewise_SC;
FUNC_SPACE EoS_DT2P_t EoS_DensTemp2Pres_Ptr = EoS_DensTemp2Pres_Piecewise_SC;
FUNC_SPACE EoS_DE2S_t EoS_DensEint2Entr_Ptr = EoS_DensEint2Entr_Piecewise_SC;
FUNC_SPACE EoS_GENE_t EoS_General_Ptr       = EoS_General_Piecewise_SC;

//-----------------------------------------------------------------------------------------
// Function    :  EoS_SetCPU/GPUFunc_Piecewise_SC
...
//
//                      EoS_SetFunc_Piecewise_SC( CPU_FuncPtr, GPU_FuncPtr );
//
//                3. Call-by-reference
//
...
#ifdef __CUDACC__
__host__
void EoS_SetGPUFunc_Piecewise_SC( EoS_DE2P_t &EoS_DensEint2Pres_GPUPtr,
...
void EoS_SetCPUFunc_Piecewise_SC( EoS_DE2P_t &EoS_DensEint2Pres_CPUPtr,
...
void EoS_SetAuxArray_Piecewise_SC( double [], int [] );
void EoS_SetCPUFunc_Piecewise_SC( EoS_DE2P_t &, EoS_DP2E_t &, EoS_DP2C_t &, EoS_DE2T_t &, EoS_DT2P_t &, EoS_DE2S_t &, EoS_GENE_t & );
#ifdef GPU
void EoS_SetGPUFunc_Piecewise_SC( EoS_DE2P_t &, EoS_DP2E_t &, EoS_DP2C_t &, EoS_DE2T_t &, EoS_DT2P_t &, EoS_DE2S_t &, EoS_GENE_t & );
#endif

//-----------------------------------------------------------------------------------------
// Function    :  EoS_Init_Piecewise_SC
...
void EoS_Init_Piecewise_SC()
{
   ...
   EoS_SetAuxArray_Piecewise_SC( EoS_AuxArray_Flt, EoS_AuxArray_Int );
   EoS_SetCPUFunc_Piecewise_SC( EoS_DensEint2Pres_CPUPtr, EoS_DensPres2Eint_CPUPtr,
                                 EoS_DensPres2CSqr_CPUPtr, EoS_DensEint2Temp_CPUPtr,
                                 EoS_DensTemp2Pres_CPUPtr, EoS_DensEint2Entr_CPUPtr,
                                 EoS_General_CPUPtr );
#  ifdef GPU
   EoS_SetGPUFunc_Piecewise_SC( EoS_DensEint2Pres_GPUPtr, EoS_DensPres2Eint_GPUPtr,
